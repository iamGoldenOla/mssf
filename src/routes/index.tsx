            ...
            <div className="relative w-full overflow-hidden">
              <div className="flex gap-6 animate-marquee pause-marquee py-2">
                {[
                  ...
                  <div key={`${partner.name}-${idx}`} className={`flex flex-col items-center justify-center border-2 ${idx % 2 === 0 ? 'border-gold/50' : 'border-green/50'} p-5 bg-card rounded-sm shadow-sm hover:-translate-y-0.5 transition-all duration-300 w-72 h-36 text-center flex-shrink-0`}>
                    {partner.logo ? (
